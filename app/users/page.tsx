...
export default function UsersPage() {
  ...
  useEffect(() => {
    if (currentUser !== null && !isAdmin) router.replace("/");
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-3xl mx-auto w-full px-4 py-8 flex-1">
        ...
        {loading ? (
          ...
          <p className="text-gray-400 dark:text-slate-500 text-sm">{search ? "No users match your search." : "No users yet."}</p>
        ) : (
          <>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-6">
                <button
                  ...
                  className="px-3 py-1.5 text-sm rounded-lg border border-gray-300 dark:border-slate-600 text-gray-600 dark:text-slate-300 disabled:opacity-40 disabled:cursor-default hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors"
                >
                  Previous
                </button>
